...
import ADTMap.TreeMap.Entry;
import ADTMap.TreeMap.Map;
import ADTMap.TreeMap.Tuple;
...
public class TreeMapTest {
	...
	@DataPoint
	public static Map<String, Integer> testMap = TreeMap.empty();
	...
	public void isEmpty_empty() {
		Map<String, Integer> test = TreeMap.empty();
	...
	public void member_delete(String k1, String k2, int v, int v2) {
		Map<String, Integer> t = TreeMap.empty();
		t = t.insert(k1, v);
		t = t.insert(k2, v2);
		t = t.delete(k1);
	...
	public void delete_insert(Map<String, Integer> t1, Map<String, Integer> t2, String k1, String k2, int v,
		...
		t1 = TreeMap.fromList(a);
		t1.insert(k1, v);
		t1.delete(k2);

		if (k1.equals(k2)) {
			t2 = TreeMap.fromList(a);
			t2.insert(k1, v);
			t2.delete(k2);
	...
	public void testGroupBy(String k1, String k2, int v1, int v2){
		...
		ADTMap.Map<Object, ADTList<Payment>> map = list.groupBy(x->x.name);
